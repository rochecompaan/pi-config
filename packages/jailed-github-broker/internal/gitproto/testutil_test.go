...
func receiveOptions(maxBytes int) ReceiveOptions {
	return ReceiveOptions{MaxBytes: maxBytes, AdvertisedCaps: standardCapabilities()}
}

func receiveCertificateOptions(maxBytes int) ReceiveOptions {
	return ReceiveOptions{MaxBytes: maxBytes, AdvertisedCaps: certificateCapabilities()}
}
