...
// ParseAdvertisedCapabilities reads one v0 receive-pack advertisement exactly.
func ParseAdvertisedCapabilities(input io.Reader, maxBytes int) (Advertisement, error) {
